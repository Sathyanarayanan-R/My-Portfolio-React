      ...
      <InfoContainer lightBg={false} id="about">
        ...
        <div className="row">
          ...
          <div className="col-md-6 col-sm-12" data-aos="fade-left">
            <p>
              Courteous and enthusiastic, I am interested in Software
              Development. I recently began to be fascinated by web
              programming, e.g., developing apps and building websites. I
              gained some experience of working in this area. I am keen to gain
              more experience in this field, for this reason, I am looking for a
